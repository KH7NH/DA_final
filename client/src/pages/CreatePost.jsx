...
const CreatePost = () => {
  ...
  const handleSubmit = async () => {
    // ❌ KHÔNG return toast.error ở đây vì sẽ làm promise resolve
    ...
    try {
      ...
      // ✅ server trả 200 nhưng success=false vẫn phải throw
      if (!data?.success) {
        throw new Error(data?.message || "Post Not Added");
      }

      return data; // ✅ chỉ resolve khi thật sự OK
    } catch (err) {
        ...
        <div className="max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-300">
            ...
            <button
              disabled={loading}
              onClick={onPublish}
              className="text-sm bg-gradient-to-r from-[oklch(55.6%_0_0)] to-[oklch(14.1%_0.005_285.823)]
                hover:from-[oklch(21.6%_0.006_56.043)] hover:to-[oklch(25%_0.006_56.043)]
