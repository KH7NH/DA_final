    ...
    const handleCreateStory = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                toast.error(data.message || "Create story failed");
            }
            ...
            // ✅ CHẶN NGƯỜI CHƯA XÁC MINH TUỔI
            if (status === 403 && serverData?.code === "AGE_VERIFICATION_REQUIRED") {
                toast.error("🔞 You need to verify your age (18+) to post sensitive content.");
                return;
            }
        ...
        <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4'>
            <div className='w-full max-w-md'>
                ...
                <button onClick={() => toast.promise(handleCreateStory(), {
                    loading: 'Saving...',
                })} className='flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-gradient-to-r from-[oklch(55.6%_0_0)] to-[oklch(14.1%_0.005_285.823)]
        hover:from-[oklch(21.6%_0.006_56.043)] hover:to-[oklch(25%_0.006_56.043)] active:scale-95 transition cursor-pointer'>
